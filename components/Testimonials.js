...
function Testimonials() {
    return (
        <section className='section-testimonials md:grid-cols-1 gap-y-16 lg:gap-y-11 md:gap-y-0 bg-orange-light' id='testimonials'>
            <div className='p-20 lg:py-20 lg:px-8'>
                ...
                <div className='grid grid-cols-2 xs:grid-cols-1  gap-y-12 gap-x-20 lg:gap-x-16 lg:gap-y-9'>
            ...
            <div className='grid grid-cols-3 xl:grid-cols-2 md:grid-cols-6 xs:grid-cols-4 gap-4 sm:gap-2 p-4'>
